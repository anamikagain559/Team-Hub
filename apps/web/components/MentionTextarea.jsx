...
export default function MentionTextarea({ value, onChange, placeholder, className, rows = 4 }) {
  ...
  return (
    <div className="relative w-full">
      <textarea
        ...
        className={cn(
          "w-full rounded-xl border border-white/10 bg-white/5 px-4 py-2.5 text-sm text-white placeholder:text-slate-600 focus:border-primary/50 focus:outline-none focus:ring-1 focus:ring-primary/50 transition-all resize-none",
          className
        )}
      />
      ...
      {showSuggestions && (
        <div 
          className="absolute left-0 bottom-full mb-2 w-64 overflow-hidden rounded-2xl border border-white/10 bg-[#0c0c0c] shadow-2xl animate-in fade-in slide-in-from-bottom-2 duration-200 z-[100]"
        >
